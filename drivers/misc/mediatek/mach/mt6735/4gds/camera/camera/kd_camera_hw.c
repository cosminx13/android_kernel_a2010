...
u32 pinSet[3][8] = {
    ...
    if (DUAL_CAMERA_MAIN_SENSOR == SensorIdx && (0 == strcmp(SENSOR_DRVNAME_HI545_MIPI_RAW, currSensorName))){
        pinSetIdx = 0;
    }
    else if (DUAL_CAMERA_SUB_SENSOR == SensorIdx && (0 == strcmp(SENSOR_DRVNAME_OV2680_MIPI_RAW, currSensorName))) {
        pinSetIdx = 1;
    }

...
#if defined(CONFIG_MTK_BQ24158_SUPPORT) || defined(CONFIG_MTK_FAN5405_SUPPORT)
#define AC_CHARGER_CURRENT					CHARGE_CURRENT_1250_00_MA //1.25A
#elif defined(CONFIG_MTK_BQ24196_SUPPORT) || defined(CONFIG_MTK_BQ24296_SUPPORT) || defined(CONFIG_MTK_BQ24261_SUPPORT)
#define AC_CHARGER_CURRENT					CHARGE_CURRENT_1800_00_MA
#elif defined(CONFIG_MTK_NCP1854_SUPPORT)
#define AC_CHARGER_CURRENT					CHARGE_CURRENT_2000_00_MA //1.5A, max charging 2.5A
...
/* For open ncp1855 power path */
#define NCP1854_PWR_PATH

/*For disable ncp1855 factory mode*/

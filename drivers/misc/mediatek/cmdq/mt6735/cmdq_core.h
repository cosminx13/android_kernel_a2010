...
#define CMDQ_MAX_DUMPFIRSTERROR_COUNT	(8*1024)
...
typedef enum CMDQ_MODULE_INSTRUCTION_COUNT_ENUM {
	CMDQ_MODULE_INSTRUCTION_COUNT_MDP_RDMA = 0,
	CMDQ_MODULE_INSTRUCTION_COUNT_MDP_RSZ0 = 1,
	CMDQ_MODULE_INSTRUCTION_COUNT_MDP_RSZ1 = 2,
	CMDQ_MODULE_INSTRUCTION_COUNT_MDP_WDMA = 3,
	CMDQ_MODULE_INSTRUCTION_COUNT_MDP_WROT = 4,
	CMDQ_MODULE_INSTRUCTION_COUNT_MDP_TDSHP = 5,
	CMDQ_MODULE_INSTRUCTION_COUNT_MM_MUTEX = 6,
	CMDQ_MODULE_INSTRUCTION_COUNT_VENC = 7,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_OVL0 = 8,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_OVL1 = 9,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_RDMA0 = 10,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_RDMA1 = 11,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_WDMA0 = 12,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_COLOR = 13,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_CCORR = 14,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_AAL = 15,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_GAMMA = 16,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_DITHER = 17,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_UFOE = 18,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_PWM = 19,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_WDMA1 = 20,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_MUTEX = 21,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_DSI0 = 22,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_DPI0 = 23,
	CMDQ_MODULE_INSTRUCTION_COUNT_DISP_OD = 24,
	CMDQ_MODULE_INSTRUCTION_COUNT_SODI = 25,
	CMDQ_MODULE_INSTRUCTION_COUNT_GPR = 26,
	CMDQ_MODULE_INSTRUCTION_COUNT_OTHERS = 27,
...
typedef struct RecordStruct {
	...
	/* GCE instructions count information */
#ifdef CMDQ_INSTRUCTION_COUNT
	uint32_t instructionCount[CMDQ_INSTRUCTION_COUNT_MAX];
	uint32_t writeModule[CMDQ_MODULE_INSTRUCTION_COUNT_MAX];
	uint32_t writewmaskModule[CMDQ_MODULE_INSTRUCTION_COUNT_MAX];
	uint32_t readModlule[CMDQ_MODULE_INSTRUCTION_COUNT_MAX];
	uint32_t pollModule[CMDQ_MODULE_INSTRUCTION_COUNT_MAX];
#endif
} RecordStruct;

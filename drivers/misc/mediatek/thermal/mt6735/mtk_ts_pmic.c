...
*/
	...
	printk("read_6328_efuse: g_o_vts        = %x\n", g_o_vts);
    printk("read_6328_efuse: g_degc_cali    = %x\n", g_degc_cali);
    printk("read_6328_efuse: g_adc_cali_en  = %x\n", g_adc_cali_en);
    printk("read_6328_efuse: g_o_slope      = %x\n", g_o_slope);
    printk("read_6328_efuse: g_o_slope_sign = %x\n", g_o_slope_sign);
    printk("read_6328_efuse: g_id           = %x\n", g_id);


    printk("[read_6328_efuse] Done\n");

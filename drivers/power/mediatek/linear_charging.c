 ...
 *
 * 03 03 2015 wy.chuang
 * [ALPS01967859] [SPU-DailyUse][D2][L-MR1][Power Manager]Power off device when teh device is charging, it is diaplayer low power charging icon, actually the battery is 66%.(5/5)
 * 	
 * 	.
 * 	
 * 	Review: http://mtksap20:8080/go?page=NewReview&reviewid=165141
 *
...
static void mtk_ta_BJT_check(void)
{
	...
	battery_xlog_printk(BAT_LOG_CRTI, "mtk_ta_BJT_check() vchr=%d, vbat=%d, current=%d, Watt=%d, ta_current_level=%d cnt=%d\n",

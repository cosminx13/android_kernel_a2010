...
{
	kal_uint32 data=0;
	bm_print(BM_LOG_CRTI, "[fg_zcv_int_handler]\r\n");
	wake_up_bat();
}
#endif
...
{
	battery_xlog_printk(BAT_LOG_FULL, "battery_meter_set_columb_interrupt=%d \n",val);
...
//battery_meter_set_columb_interrupt(gFG_BATT_CAPACITY_aging/100);
#endif
#endif //#if defined(FG_BAT_INT)
